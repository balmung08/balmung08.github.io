...
">
  <video id="video-player" controls style="max-width:90%; max-height:90%; background:#000;"></video>
</div>
...
### [Oct. 2024 – Jan. 2025] Intelligent Inspection Robot System for Harsh Environments in Annealing Furnace Areas 
...
### [Mar. 2024 – Sep. 2024] Multi-robot system for autonomous vehicle transfer at roll-on/roll-off terminals 
