...
![1.png](../blog_pic/ocr%20(2).png#pic_center){width=60%, style="display: block; margin: auto;"}
#### 1.公式位置识别
...
![2.png](../blog_pic/ocr%20(1).png){width=50%, style="display: block; margin: auto;"}<br>
...
![3.png](../blog_pic/ocr%20(3).png){width=50%, style="display: block; margin: auto;"}<br>
