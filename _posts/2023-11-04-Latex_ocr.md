...
{% include ../blog_pic/ocr1.html url="../blog_pic/ocr%20(2).png" alt="Alt Text" %}
#### 1.公式位置识别
...
{% include ../blog_pic/ocr1.html url="../blog_pic/ocr%20(1).png" alt="Alt Text" %}<br>
...
{% include ../blog_pic/ocr1.html url="../blog_pic/ocr%20(3).png" alt="Alt Text" %}<br>
